    ...
    for itr in range(opt.total_epochs):
        ...
        if itr % 10==0:
            ...
            with torch.no_grad():
                ...
                writer.add_scalar(tag='Evaluation/rmse_temporal_t',scalar_value=np.sqrt(rmse_temporal/total_num),global_step=itr)
                ...
                writer.add_scalar(tag='Evaluation/distance_spatial_t',scalar_value=mae_spatial/total_num,global_step=itr)
